...
fabricantes (Fig. \figref{fig:openxr-companies}) como reemplazo a sus
...
\figref{fig:openxr}) que además les permite aprovechar cualquier
...
resultado una estimación de la velocidad del espacio. La
...
suficientemente rápidos como se ve en la \figref{fig:rolling-shutter}.
...
Además de las problemáticas presentadas en la
\figref{fig:expgain-grids}, existen otros problemas a considerar
...
principal forma de tracking; en la \figref{fig:northstar-t265}.jpg se
