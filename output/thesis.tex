...
\footnote{La expresión \(A^T A x = A^T b\) suele ser referida como
  ...
  mediante cálculo referirse a \autocite[cap.
  10]{nocedalNumericalOptimization2006}.} \footnote{La expresión
...
\autocite[cap. 10]{nocedalNumericalOptimization2006}. En el caso no
...
El desarrollo de esta sección está basada en \autocite[cap. 1, 2 y
10]{nocedalNumericalOptimization2006} y \autocite[cap. 11, 12, 15 y
18]{boydIntroductionAppliedLinear2018}; en esos trabajos se puede
encontrar derivaciones alternativas e información de alternativas a
Gauss-Newton más sofisticadas como Levenberg-Marquardt o el método
dogleg.
...
\autocite{mur-artalVisualInertialMonocularSLAM2017} se habla de
...
tradicional \autocite{williamsPyramidalParametrics1983} de almacenar una
...
\autocite{rostenFasterBetterMachine2010a} implementado sobre OpenCV.
Aquí es notable aclarar que Basalt es uno de los sistemas que menos
depende de OpenCV, ya que tiende a re implementar muchas de las técnicas
y algoritmia de forma especializada y, como veremos en otros módulos,
...
\autocite{lucasIterativeImageRegistration1981}. El uso adicional de
mipmaps sobre KLT fue originalmente expuesto en
\autocite{bouguetPyramidalImplementationLucas1999}.
...
el acelerómetro tenga ceros en su triángulo superior (ver \autocite[
secc. IV.B]{schubertBasaltTUMVI2018} y \emph{discusión relacionada
...
\autocite{forsterOnManifoldPreintegrationRealTime2017} y las expresiones
...
extrapolar hacia el pasado lejano\footnote{La especificación de OpenXR
  ...
  futuro por parte del usuario. Ver \autocite[secc.
  2.14]{thekhronosgroupinc.OpenXRSpecification}}, o sea fuera del
registro del historial, se utilizará el espacio más antiguo almacenado y
\(\Delta T^{-1}\).
...
sección \textcite{seq:basalt-preintegration} con algunas ideas
relacionadas con las ecuaciones presentadas a partir de la
...
\autocite{casiezFilterSimpleSpeedbased2012}. Además, dicho trabajo cubre
...
\addcontentsline{toc}{section}{Windows Mixed Reality}
