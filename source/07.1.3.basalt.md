<!-- TODO: explicar bundle adjustment -->
...
<!-- TODO: Que es OpenCV -->
<!-- TODO@concept: Que son grafos de poses, factor graphs, y factores -->
...
<!-- TODO@concept: Que es cuadrados minimos -->
<!-- TODO@concept: Que es gauss newton -->
<!-- TODO@concept: levenverg-marquard is also in use (see vio_lm_lambda_initial), I might need to explain it -->
<!-- TODO@concept: que son SE(2), etc: ver https://ethaneade.com/ -->
